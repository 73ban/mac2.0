...
latest_catalyst_summary: ???????????? / 新潮能源?????油气开采 / ??????????
```
...
- 2026-06-23 20:38:30 | auto-refresh | signal=C | themes=油气 / 油气开采; catalyst=???????????? / 新潮能源?????油气开采 / ??????????
- 2026-06-23 10:20:31 | auto-create | signal=C | themes=油气 / 油气开采; catalyst=???????????? / 新潮能源?????油气开采 / ??????????
  ...
  "history": [
    {
      ...
      "signalGrade": "C",
      "changeType": "auto-refresh",
      "summary": "themes=油气 / 油气开采; catalyst=???????????? / 新潮能源?????油气开采 / ??????????"
    },
    {
