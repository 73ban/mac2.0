...
latest_catalyst_summary: ???????????? / 睿智医药?????医疗服务 / ??????????
```
...
- 2026-06-23 20:38:30 | auto-refresh | signal=C | themes=医疗服务 / 医药; catalyst=???????????? / 睿智医药?????医疗服务 / ??????????
- 2026-06-23 10:00:32 | auto-create | signal=C | themes=医疗服务 / 医药; catalyst=???????????? / 睿智医药?????医疗服务 / ??????????
  ...
  "history": [
    {
      ...
      "signalGrade": "C",
      "changeType": "auto-refresh",
      "summary": "themes=医疗服务 / 医药; catalyst=???????????? / 睿智医药?????医疗服务 / ??????????"
    },
    {
