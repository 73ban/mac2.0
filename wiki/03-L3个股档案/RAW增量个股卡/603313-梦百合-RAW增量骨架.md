...
- 2026-06-22 09:34:41 | auto-refresh | signal=C | themes=家居用品; catalyst=???????????? / 梦百合?????家居用品 / ??????????
- 2026-06-20 10:21:25 | auto-refresh | signal=C | themes=家居用品; catalyst=???????????? / 梦百合?????家居用品 / ??????????
- 2026-06-19 19:01:36 | auto-create | signal=C | themes=家居用品; catalyst=???????????? / 梦百合?????家居用品 / ??????????
...
<!-- 73WIKI:AUTO_META:START -->
{
  ...
  "history": [
    ...
    },
    {
      ...
      "signalGrade": "C",
      "changeType": "auto-refresh",
      "summary": "themes=家居用品; catalyst=???????????? / 梦百合?????家居用品 / ??????????"
    },
    {
