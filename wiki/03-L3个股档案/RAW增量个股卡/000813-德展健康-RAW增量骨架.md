...
latest_catalyst_summary: ???????????? / 德展健康?????化学制药 / ??????????
```
...
- 2026-06-23 20:38:30 | auto-refresh | signal=C | themes=化学制药; catalyst=???????????? / 德展健康?????化学制药 / ??????????
- 2026-06-23 09:50:29 | auto-create | signal=C | themes=化学制药; catalyst=???????????? / 德展健康?????化学制药 / ??????????
  ...
  "history": [
    {
      ...
      "signalGrade": "C",
      "changeType": "auto-refresh",
      "summary": "themes=化学制药; catalyst=???????????? / 德展健康?????化学制药 / ??????????"
    },
    {
